...
function renderCorrectAnswer() {
    ...
    <img src="images/correct.png" alt="answer-pic" class="answer-pics images" height="300px" width="300px">
...
function renderWrongAnswer(correct) {
    ...
    <img src="images/wrong.jpg" alt="answer-pic" class="answer-pics simages" height="300px" width="300px">
